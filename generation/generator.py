...
from generation.utils import get_cam_relative_params2, transform_param
...
class SceneGenerator():
    ...
    def generate_scenes(self, N, objtype, write_csv=True, save_imgs=True):
